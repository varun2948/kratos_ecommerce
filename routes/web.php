...
Route::get('/shop',         ['as' => 'shop',         'uses' => 'ShopCategoryController@index']);
Route::get('/shop/{category}',         ['as' => 'shop.category',         'uses' => 'ShopCategoryController@getproductbycat']);
Route::get('/search',         ['as' => 'search',         'uses' => 'ShopCategoryController@search']);
