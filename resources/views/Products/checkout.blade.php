...
<div class="checkout-section">
    <div>
        ...
        @csrf
            <!-- <input type="hidden" name="_token" value="3Ivsleg6Bnw1jmeQaa5oKeYON6pGtI6DCR3JixBq"> -->
            ...
            <div class="mt-32">
                ...
                <form method="post" id="paypal-payment-form" action="">
                    <input type="hidden" name="_token" value="3Ivsleg6Bnw1jmeQaa5oKeYON6pGtI6DCR3JixBq">                            <section>
    ...
    <div class="checkout-table-container">
            ...
            <div class="checkout-table-row">
                <div class="checkout-table-row-left">
                    ...
                    <div class="checkout-item-details">
                        ...
                        <div class="checkout-table-price">Rs. {{$item->price}}</div>
                    </div>
        ...
        <div class="checkout-totals">
            ...
            <div class="checkout-totals-right">
                ...
                <span class="checkout-totals-total">Rs.{{Cart::subtotal()}}</span>
...
@section('js')
  ...
  <script>
    var stripe = Stripe('pk_test_wr7nwOuNs2sYF6TpU4tMfIPT00mbKcOlUL');
