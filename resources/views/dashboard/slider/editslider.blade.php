                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="{{ route('admin.slider.update',$data['row']->id)}}" method="POST" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="sort_order" name="sortorder" placeholder="Enter Sort Order" value="{{ !empty($data['row']->sortorder) ? $data['row']['sortorder']:'' }}">
                                </div>
<!--
                                <div class="checkbox">
                                    <label>
